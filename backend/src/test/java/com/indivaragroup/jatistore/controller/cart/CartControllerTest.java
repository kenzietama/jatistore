...
//                .andExpect(jsonPath("$.restApiResponseHttpCode").value(200))
//                .andExpect(jsonPath("$.restApiResponseHttpStatus").value("OK"))
//                .andExpect(jsonPath("$.restApiResponseMessage").value("Cart retrieved successfully."))
//                .andExpect(jsonPath("$.restApiResponseData.items[0].productName").value("Test Product"))
//                .andExpect(jsonPath("$.restApiResponseData.totalPrice").value(200.00));
//
...
//        mockMvc.perform(get("/api/v1/cart"))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.restApiResponseMessage").value("Your cart is empty."))
//                .andExpect(jsonPath("$.restApiResponseData.items").isEmpty())
//                .andExpect(jsonPath("$.restApiResponseData.totalPrice").value(0));
//
//        verify(cartService, times(1)).getCartByUserId(any(UUID.class));
//    }
//
...
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.restApiResponseHttpCode").value(200))
//                .andExpect(jsonPath("$.restApiResponseMessage").value("Product added to cart successfully."))
//                .andExpect(jsonPath("$.restApiResponseData").value(cartItemId.toString()));
//
...
//                        .content(objectMapper.writeValueAsString(request)))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.restApiResponseMessage").value("Cart item updated successfully."));
//
...
//                        .with(csrf()))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.restApiResponseMessage").value("Cart item removed successfully."));
//
